...
<%
	...
	if (ORACLE=1) then
		cmdTemp.CommandText="declare per number; rc BYROYALTYPKG.RCT1;begin byroyalty(per,rc) end;"
	else
		cmdTemp.CommandText="declare @per int begin exec byroyalty @per end"
	end if
