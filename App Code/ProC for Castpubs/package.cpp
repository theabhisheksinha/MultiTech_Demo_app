...
{
    47,
    "C:\\Work_in_progress\\C et C++\\ProCfch\\package.pc"
};


static unsigned long sqlctx = 2112617069;
...
{10,4130,0,0,0,
5,0,0,1,0,0,27,43,0,0,4,4,0,1,0,1,97,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,41,0,122,50,0,0,1,1,0,1,0,1,3,0,0,
55,0,0,3,0,0,29,52,0,0,0,0,0,1,0,
70,0,0,4,42,0,122,64,0,0,2,2,0,1,0,1,9,0,0,1,3,0,0,
93,0,0,5,0,0,30,66,0,0,0,0,0,1,0,
108,0,0,6,0,0,32,87,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[16]; } id_VARCHAR;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "call salepkg.insert_sales_proc(:b0,15,20)";
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "call defectspkg.ctrl_defect(:b0) into :b1 ";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (         void  *)&id_VARCHAR;
